...
{{- default (printf "%s-backend" (include "todo-chatbot.fullname" .)) .Values.backend.serviceAccount.name }}
{{- end }}
...
{{- default (printf "%s-frontend" (include "todo-chatbot.fullname" .)) .Values.frontend.serviceAccount.name }}
{{- end }}
